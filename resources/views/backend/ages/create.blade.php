        ...
        <div class="card-header py-3 d-flex">
            ...
            <div class="ml-auto">
                <a href="{{ route('admin.ages.index') }}" class="btn btn-primary">
                    ...
                    <span class="text">Back to age</span>
                </a>
            </div>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="name" type="text" name="from_age" value="{{ old('from_age') }}">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="name" type="text" name="to_age" value="{{ old('to_age') }}">
                            @error('name')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                    </div>
